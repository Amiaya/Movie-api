...
exports.GetAllUser = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
    var user, err_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
...
exports.UpdateUser = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, User.findByIdAndUpdate(req.params.id, req.body)];
            case 1:
                user = _a.sent();
                res.status(200).json({
                    status: "success",
...
exports.GetUser = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
    var user, movie, err_4;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 4, , 5]);
                return [4 /*yield*/, User.findById(req.params.id).populate('topMovies')];
            case 1:
                user = _a.sent();
